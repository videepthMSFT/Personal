...
var EmployeeCountComponent = /** @class */ (function () {
    function EmployeeCountComponent() {
        ...
        this.countRadioButtonChange = new core_1.EventEmitter();
    }
    EmployeeCountComponent.prototype.onRadioButtonChange = function () {
    ...
    ], EmployeeCountComponent.prototype, "countRadioButtonChange", void 0);
    __decorate([
        core_1.Input(),
